...
class DataModelManager {
    ...
    var chinookCustomer: Chinook_Customer?
    var chinookCustomerWithEmployee: Chinook_Customer?
    var chinookCustomers = [Chinook_Customer]()
    
    var sictEmployee: SICT_Employee?
    var sictEmployees = [SICT_EmployeeBase]()
