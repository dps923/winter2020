...
This scene and controller enables the user to add a new food item to the list. Some data will be provided by the user: 
* name
* source
* notes
* quantity
...
The "quantity" UI should be a segmented button, with segments for these values: 25, 50, 100, 125, 250, 500
