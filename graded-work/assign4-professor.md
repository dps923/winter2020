...
In this assignment, you will need a read-write web API. (Add to your existing restdb.io configuration.)
...
If necessary, generate an API key. It is likely that you can reuse the API key that you previously generated for Assignment 3. 
...
You have seen all this before, during week 8+ coverage, and in the code examples. 

At the end of this section, you should have a working two-scene app. 

<img src="images/a4-list.png" class="border1" alt="List" />&nbsp;&nbsp;<img src="images/a4-scene.png" class="border1" alt="Scene" />
...
**xxxAdd.swift**  
**xxxEdit.swift**  
**xxxDetail.swift** (DPS923 students only)  
