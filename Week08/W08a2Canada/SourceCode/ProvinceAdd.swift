...
class ProvinceAdd: UIViewController {
    ...
    @IBAction func save(_ sender: UIBarButtonItem) {
        ...
        */
        ...
        // Alternate form, perhaps preferred
        let newItem2 = Province(context: m.ds_context)
        newItem2.name = provinceName.text
        newItem2.premier = provincePremier.text
        newItem2.area = Int32(area)
        newItem2.yearFounded = Int32(yearFounded)
        m.ds_save()
